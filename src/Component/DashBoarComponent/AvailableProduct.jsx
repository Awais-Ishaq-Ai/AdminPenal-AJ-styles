...
const productsData = [
    ...
    { id: 4, name: "Pant", available: false, purchaseFrom: "Malenium Mools", price: 2000, totalStock: 80, remainingStock: 10, purchasePrice: 1500 },
    { id: 5, name: "Shalwar Kameez", available: false, purchaseFrom: "AJ store", price: 2000, totalStock: 80, remainingStock: 1, purchasePrice: 1500 },
];
        ...
        <div className="h-[92vh] overflow-y-auto bg-[#002022] text-white p-5 flex justify-center">
            <div className="w-full p-5 rounded-lg shadow-lg">
                        ...
                        {productsData.map((product) => {
                            ...
                            return (
                                <tr key={product.id} className="bg-gray-700">
                                    ...
                                    <td className="border border-gray-500 p-2">{product.purchaseFrom}</td>
                                    <td className="border border-gray-500 p-2">Rs. {product.price}</td>
                                    <td className="border border-gray-500 p-2">{product.totalStock}</td>
                                    <td className={`border border-gray-500 p-2 ${product.remainingStock === 0 ? "bg-red-500" : ""}`}>
                ...
                <div className="mt-5 text-lg">
                    ...
                    <p><strong>Total Profit:</strong> Rs. {totalProfit}</p>
                </div>
            </div>
